...
const Camp = () => {
  return (
    ...
    <section className="lg:max-container  relative flex flex-col padding-container py-10 lg:mb-10 lg:py-20 xl:mb-20">
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6  ">
        <div
          className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rouned-5xl xl:px-16 xl:py-20 relative w-full
